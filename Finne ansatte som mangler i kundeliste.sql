...
dbo.[Tbl_Kvotefiler fra Zalaris].ID
FROM
...
GROUP BY dbo.[Tbl_Kvotefiler fra Zalaris].Ansattnummer, dbo.[Tbl_Kvotefiler fra Zalaris].Etternavn, dbo.[Tbl_Kvotefiler fra Zalaris].Fornavn, dbo.[Tbl_Kvotefiler fra Zalaris].ID
;